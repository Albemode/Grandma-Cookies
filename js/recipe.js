...
function peanutbutterSet() {
  ...
  lemonCounter++
    document.getElementById("PBC").innerHTML = "Lemon Cookies: " + lemonCounter;
}
...
function sugarcoatSet() {
  ...
  sugarCounter++
    document.getElementById("SC").innerHTML = "Sugar Coat Cookies: " + sugarCounter;
        if (Cookies.get("cookSugarCoat") != null) {
            Cookies.set("cookSugarCoat", (parseInt(Cookies.get("cookSugarCoat")) + SugarCoat));
              $("#SC").html(Cookies.get("cookSugarCoat"));
        } else {
          Cookies.set("cookieSugar", sugar);
          $("#cookSugarCoat").html(Cookies.get("cookieSugar"));
    }
}
...
function myBtn() {
  ...
  Cookies('cookSugarCoat', 0);
      document.getElementById("SC").innerHTML = "Sugar Coat Cookies: 0";
}
